    ...
    <div className='w-36 md:w-48 pr-4'>
        ...
        {showDetails && (
          <div className='absolute left-0 right-0 m-auto bg-sky-400 hover:bg-sky-700 w-[30%] transform-gpu scale-150 text-white rounded-lg'>
            ...
            <h2 className='p-2 font-bold'>{title}, Rating:{IMDBRating} </h2>
            <div>
              <button className='p-2 bg-white text-black py-1 md:py-0 px-3 md:px-4 text-sm rounded-lg hover:bg-opacity-80'> ▶️Play</button>
              <button className='p-2 bg-white ml-1 text-black py-1 md:py-0 px-3 md:px-4 text-sm rounded-lg hover:bg-opacity-80'> ⬇️Download</button>
            </div>
